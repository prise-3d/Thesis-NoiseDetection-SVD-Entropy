                ...
                for start in {0,50,100,150}; do
                    for end in {50,100,150,200}; do
                        ...
                        if [ $result -gt 0 ]; then
                            ...
                            echo python methods/compute_${method}_entropy.py --data data/generated/sobel_svd_entropy_data_imnorm${imnorm}_${ksize}_${start}_${end}.csv --norm ${norm} --std ${std} --output entropy_${method}_imnorm${imnorm}_norm${norm}_std${std}_${ksize}_${start}_${end}.csv
    
                            output_filename="${output_directory}/vdp_comparisons_${method}_imnorm${imnorm}_norm${norm}_std${std}_${metric}_${ksize}_${start}_${end}"
