...
'''
Apply sobel filter on image value from an image
'''
def get_sobel_filtered_img(lab_img, k_size=3):
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Compute sobel complexity on scene images")
    ...
    for scene in scenes_list:
        ...
        for img_path in images_path[scene]:
            ...
            complexity_list = get_zone_sobel_svd_entropy(blocks, p_interval, p_ksize, p_imnorm)
