                ...
                for start in {0,50,100,150}; do
                    for end in {50,100,150,200}; do
                        ...
                        if [ $result -gt 0 ]; then
                            ...
                            output_filename="${output_directory}/comparisons_imnorm${imnorm}_${method}_norm${norm}_std${std}_${metric}_k${ksize}_${start}_${end}"
                            ...
                            for scene in {"A","B","C","D","E","F","G","H","I"}; do
                                ...
                                python utils/reconstruct_image_estimated.py --data data/thresholds/entropy_${method}_imnorm${imnorm}_norm${norm}_std${std}_k${ksize}_${start}_${end}.csv --scene ${scene} --output data/images/${scene}_${method}_imnorm${imnorm}_norm${norm}_std${std}_k${ksize}_${start}_${end}_estimated.png
